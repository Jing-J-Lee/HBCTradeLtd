...
public class ContractAdapterFolder extends RecyclerView.Adapter<ContractAdapterFolder.MyViewHolder> {
    ...
    public ContractAdapterFolder(Context context, List<String> datas) {
